...
const { AAVE_POOL_ADDRESS, AAVE_PRICE_ORACLE_ADDRESS } = getEnv();

export const AAVE_V3_MAINNET_POOL_ADDRESS = getAddress(
  AAVE_POOL_ADDRESS,
) as `0x${string}`;

export const AAVE_V3_PRICE_ORACLE_ADDRESS = getAddress(
  AAVE_PRICE_ORACLE_ADDRESS,
) as `0x${string}`;

export const LIQUIDATION_EVENT_TOPIC =
...
export const liquidationCallEvent = parseAbiItem(
