...
const baseEvent = {
  ...
  collateralAsset: "0x0000000000000000000000000000000000000001" as `0x${string}`,
  collateralSymbol: "USDC",
  collateralDecimals: 6,
  collateralAmountRaw: "1000000",
  collateralAmount: "1",
  collateralValueUsd: 1,
  debtAsset: "0x0000000000000000000000000000000000000002" as `0x${string}`,
  debtSymbol: "USDT",
  debtDecimals: 6,
  ...
  debtValueUsd: 1,
  notionalUsd: 1,
  user: "0x0000000000000000000000000000000000000003" as `0x${string}`,
  liquidator: "0x0000000000000000000000000000000000000004" as `0x${string}`,
  receiveAToken: false,
} satisfies Parameters<typeof insertLiquidation>[0];
